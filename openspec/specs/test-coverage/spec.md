...
Garantir a qualidade e a confiabilidade do sistema por meio de cobertura abrangente de testes: testes unitários para todo o código dos services, testes end-to-end para todos os endpoints HTTP e um limiar de cobertura aplicado automaticamente pela ferramenta.
