...
Define a autenticação e o cadastro de usuários do sistema: cadastro com email e senha, sign-in com emissão de JWT em cookie, logout e proteção de rotas por autenticação.
